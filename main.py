...
def main():
	...
	feature_extraction_param = sys.argv[4]

	#If predit param is 0, do all the preprocessing and feature extraction, else predict only
	if(feature_extraction_param=='1'):
